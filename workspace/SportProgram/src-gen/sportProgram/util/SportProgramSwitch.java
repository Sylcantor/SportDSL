 ...
 * @generated
 */
public class SportProgramSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case SportProgramPackage.PROGRAM_DURATION: {
			ProgramDuration programDuration = (ProgramDuration) theEObject;
			T result = caseProgramDuration(programDuration);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case SportProgramPackage.SPORT_PROGRAM: {
			SportProgram sportProgram = (SportProgram) theEObject;
			T result = caseSportProgram(sportProgram);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Program Duration</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Program Duration</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseProgramDuration(ProgramDuration object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Sport Program</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Sport Program</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSportProgram(SportProgram object) {
		return null;
	}
